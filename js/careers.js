...
//------------------------------------------------------------------------------------
$('#contact-form-halfbg-form-careers').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
        firstname: "required",
...
$('#contact-form-halfbg-form-careers').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                $('#contact-form-halfbg-form-careers').find('[type=submit]').button('complete');
            },
            error: function () {
                $('#contact-form-halfbg-form-careers').find('[type=submit]').button('reset');
            }
        });
    } else {
